...
(function($) {
    ...
    $.fn.iconPicker = function( options ) {
        newIcons=options.newIcons ? options.newIcons : [];
        ...
        return this.each( function() {
	        ...
	        function createUI($element){
	        	...
	        	$popup.html('<div class="ip-control"> \
						          <ul> \
						            <li><a href="javascript:;" class="btn" data-dir="-1" title="ÉÏÒ»Ò³"><span class="glyphicon  glyphicon-fast-backward"></span></a></li> \
						            <li><input type="text" class="ip-search glyphicon  glyphicon-search" placeholder="Search" /></li> \
						            <li><a href="javascript:;"  class="btn" data-dir="1" title="ÏÂÒ»Ò³"><span class="glyphicon  glyphicon-fast-forward"></span></a></li> \
						            <li><a href="javascript:;" class="btn" onclick="showImgUploadModal()" title="ÉÏ´«"  ><span class="glyphicon  glyphicon-cloud-upload"></span></a></li> \
						          </ul> \
						      </div> \
